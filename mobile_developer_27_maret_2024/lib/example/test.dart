          ...
          Column(
            children: <Widget>[
              ...
              Stack(
                  ...
                  children: <Widget>[
                    _ButterFlyAssetVideo(),
                    Image.asset('lib/common/assets/flutter-mark-square-64.png'),
                    // const Icon(Icons.square, size: 50,)
                  ]),
            ],
          ),
        ])),
...
class _BumbleBeeRemoteVideoState extends State<_BumbleBeeRemoteVideo> {
  ...
  Future<ClosedCaptionFile> _loadCaptions() async {
    final String fileContents = await DefaultAssetBundle.of(context)
        .loadString('lib/common/assets/bumble_bee_captions.vtt');
          ...
          Container(
            ...
            child: AspectRatio(
              ...
              child: Stack(
                ...
                children: <Widget>[
                  VideoPlayer(_controller),
                  // VimeoVideoPlayer(url: 'https://vimeo.com/598879402'),
